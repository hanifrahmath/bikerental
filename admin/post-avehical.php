...
<head>
	...
	<title>Bike Sharing Portal | Admin Upload Sepeda</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Upload Sepeda</h2>
...
<label class="col-sm-2 control-label">Type Sepeda<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Detail Sepeda<span style="color:red">*</span></label>
<div class="col-sm-10">
