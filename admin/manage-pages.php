...
<head>
	...
	<title>Bike Sharing Portal | Admin Create Brand</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Menejemen Halaman </h2>
                  ...
                  <option value="manage-pages.php?type=terms">Pertanyaan</option>
                  <option value="manage-pages.php?type=privacy">privasi dan Keamanan</option>
                  <option value="manage-pages.php?type=aboutus">Tentang</option>
                  <option value="manage-pages.php?type=faqs">Syarat & Ketentuan</option>
                </select>
												</div>
											</div>
