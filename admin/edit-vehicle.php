...
<head>
	...
	<title>Bike Sharing Portal | Admin </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Sepeda</h2>
...
<div class="form-group">
<label class="col-sm-2 control-label">View Sepeda<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<div class="col-sm-4"> <img src="img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
</div>
