...
<title>Bike Sharing Portal | Bike Listing</title>
<!--Bootstrap -->
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Pilih Sepedamu </h5>
          </div>
...
<option value="Petrol">MTB</option>
<option value="Diesel">HYBRID BIKE</option>
<option value="CNG">FELIX BIKE</option>
                </select>
              </div>

              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Pencarian Sepeda</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-bicycle" aria-hidden="true"></i> Daftar Sepeda</h5>
          </div>
