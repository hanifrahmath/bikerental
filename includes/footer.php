    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <li><a href="page.php?type=terms">Pertanyaan</a></li>
          </ul>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; 2018 Bike Sharing Portal. Brought To You By <a href="https://code-projects.org/">Pascailkom55</a></p>
        </div>
      </div>
    </div>
  </div>
