    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/loggo3.png" alt="image"/></a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">Pascailkom55@apps.ipb.ac.id</a> </div>
            <div class="header_widgets">
...
echo "WELCOME TO IPB BIKE SHARING";
 } ?>
          </div>
        </div>
      </div>
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="bike-listing.php">Daftar Sepeda</a>
          <li><a href="page.php?type=faqs">Syarat & Ketentuan</a></li>
